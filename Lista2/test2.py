...
from main import test2, przepustowosc, przeplyw, T
...
for m in range(10, 0, -2):
    ...
    for p in linspace(0.9, 0.99, num=5):
        ...
        plt.colorbar()
        plt.ylabel("T_max")
        plt.xlabel("Wzrost przepustowości każdego łącza p={}, m={}".format(p, m))
        plt.savefig("TEST2_{}_{}.png".format(m, p))
        plt.close()
        # print("done as TEST2_{}_{}.png".format(m, p))
